*This project has been created as part of the 42 curriculum by vchiling.*
...
- peer on the right peer on the left and someone smart in the building (some peers from above also)
